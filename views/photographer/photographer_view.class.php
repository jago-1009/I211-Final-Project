            ...
            if($photographers === 0){
                ...
                foreach ($photographers as $photographers){
                    ...
                    echo "<div class='photographer-list'>
                        <a href='", BASE_URL, "/photographer/detail/$photographerID'><div class='photographer-list-details'><h1>$firstname $lastname</h1><h4>$birthdate</h4><h4>$email</h4><p>ID: $photographerID</p></div></a>
                    </div>";
                }
            }
            ?>
